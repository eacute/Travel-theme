...
<head>
	...
	<link type="text/css" href="../webroot/css/colors/bleuclair.css" rel="stylesheet">
...
<body class="detail-page single sidebar-right">
				...
				<div class="detail_about detail">
					...
					<div id="box_desc" class="clearfix">
						...
						<div id="productTabWrap" class="clearfix">
							...
							<div id="detail_about" class="clearfix">
								<ul>
									<li><h3 class="feature-label">Contact :</h3> <span class="value">Lorem ipsum dolor sit amet  consetetur</span></li>
									<li><h3 class="feature-label">Adresse :</h3> <span class="value">103 avenue de Vaugirard, 75009 Paris, France</span></li>
									<li><h3 class="feature-label">Quartier :</h3> <span class="value">Lorem ipsum dolor sit amet  consetetur</span></li>
									<li><h3 class="feature-label">Accès :</h3> <span class="value">Lorem ipsum dolor sit amet consetetur </span></li>
									<li><h3 class="feature-label">Localisation :</h3> <span class="value">Lorem ipsum dolor sit amet consetetur </span></li>
									<li><h3 class="feature-label">Horaires d’ouverture :</h3> <span class="value">Lundi : 9h-18h, Mardi : 9h-18h, Mercredi : 9h-18h, Jeudi : 9h-18h, Vendredi : 9h-18h, Samedi : 9h-18h</span></li>
									<li><h3 class="feature-label">Récompenses :</h3> <span class="value">Lorem ipsum</span></li>
								</ul>
							</div>
						</div>
