...
<head>
	<meta charset="utf-8">
	<title>Travel Theme v1 : home v1</title>
	...
	<link type="text/css" href="../webroot/css/print.css" rel="stylesheet" media="print">
		<link type="text/css" href="../webroot/css/colors/marron.css" rel="stylesheet">
	...
	<div id="header" class="clearfix">
		<div class="container">
			...
			<div class="colwrapper pull-right clearfix">
				<div id="welcome-box">
					<h1 class="ttre">Bienvenue</h1>
					<p class="desc">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
					<p class="readmore"><a title="" href="#">En savoir plus</a></p>
				</div>
				<div id="contact-box">
						...
						<li class="span5">
							<div class="thumbnail clearfix">
								<div class="caption">
									...
									<p class="date_from">31 mars 2012</p>
									<h3 class="ttre"><a title="" href="#">Lorem ipsum dolor sit amet consetetur.</a></h3>
									<p class="desc">Lorem ipsum dolor sit amet, consetetur sadipscin sed diam nonumy eirmod tempor invidunt ut lab.</p>
								</div>
							</div>
						</li>
						<li class="span5">
							<div class="thumbnail clearfix">
								<div class="caption">
									<p class="cat">événement</p>
									<p class="date_from">Du 12 au 23 octobre 2012</p>
									<h3 class="ttre"><a title="" href="#">Lorem ipsum dolor sit amet consetetur.</a></h3>
									<p class="desc">Lorem ipsum dolor sit amet, consetetur sadipscin sed diam nonumy eirmod tempor invidunt ut lab.</p>
								</div>
							</div>
