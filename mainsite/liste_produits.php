...
<body class="list list-products sidebar-right">
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><a title="" href="#">Liste établissements </a> <span class="divider">&rsaquo;</span></li>
				...
				<div class="listing_controls top clearfix">
					<div class="ordering_wrap pull-left">
						<div class="order-controls btn-group">
							<label title="" class="">Tri alphabetique</label>
							<div class="controls clearfix">
								<a class="inc m-btn rpl" href="javascript:;"><span>+</span></a>
								<a class="dec m-btn rpl" href="javascript:;"><span>-</span></a>
							</div>
						</div>
						<div class="order-controls btn-group">
							<label title="" class="">Date</label>
							<div class="controls clearfix">
								<a class="inc m-btn rpl" href="javascript:;"><span>+</span></a>
								<a class="dec m-btn rpl" href="javascript:;"><span>-</span></a>
							</div>
					...
					<div class="pagination pull-right">
						<ul>
							<li class="prev"><a title="" href="#">&lsaquo;</a></li>
							<li class="active"><a title="" href="#">1</a></li>
							<li><a title="" href="#">2</a></li>
							<li><a title="" href="#">3</a></li>
							<li><a title="" href="#">4</a></li>
							<li class="next"><a title="" href="#">&rsaquo;</a></li>
						</ul>
					</div>
				</div>
	...
	<div id="footer" class="notice clearfix">
		<div class="container">
			...
			<div class="pull-left col col2">
				<div class="gmap" >
					<a title="" href="#contact"><img src="http://maps.googleapis.com/maps/api/staticmap?center=Place+d+armes,Luxembourg&amp;zoom=14&amp;size=160x120&amp;maptype=roadmap&amp;markers=size:mid%7Ccolor:red%7CPlace+d+armes,Luxembourg,CA&amp;sensor=true" alt="#"/></a>
				</div>
